...
def init(k: Flask, ext_logger: logging.Logger, run_d: str):
    ...
    def append_word():
        ...
        concert = requests.get(
            "http://127.0.0.1:5000/extension/main.basic.english.dictionary/get/root?word="
            + concert
        )
        if concert.status_code == 200:
            ...
            return Response(
                "Get root word from '/extension/main.basic.english.dictionary/get/root' failed",
                500,
            )
